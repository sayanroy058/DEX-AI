  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "flash-buy": { "0%": { backgroundColor: "hsl(var(--buy) / 0.4)" }, "100%": { backgroundColor: "transparent" } },
        "flash-sell": { "0%": { backgroundColor: "hsl(var(--sell) / 0.4)" }, "100%": { backgroundColor: "transparent" } },
        "glow-pulse": {
          "0%, 100%": { boxShadow: "0 0 16px hsl(var(--primary) / 0.3)" },
          "50%": { boxShadow: "0 0 28px hsl(var(--primary) / 0.6)" },
        },
      ...
      animation: {
        ...
        "flash-buy": "flash-buy 0.6s ease-out",
        "flash-sell": "flash-sell 0.6s ease-out",
